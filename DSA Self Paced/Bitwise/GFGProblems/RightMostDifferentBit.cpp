/**
 * @file RightMostDifferentBit.cpp
 * @author ADITYA BHARDWAJ
 * @brief Given two numbers M and N. The task is to find the position of the rightmost different bit in the binary representation of numbers.
